...
public class AmazonDynamoDBDAO {
     ...
     *      (C:\\Users\\vabbu\\.aws\\credentials) where the sample code will load the
     *      credentials from.
    ...
    private static void init() throws Exception {
        ...
        try {
            ...
            throw new AmazonClientException(
                    ...
                    "location (C:\\Users\\vabbu\\.aws\\credentials), and is in valid format.",
                    e);
        }
